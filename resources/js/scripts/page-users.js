$(document).ready(function() {
    ...
    // page users longno role filter
    $("#users-list-longno").on("change", function() {
        var usersLongnoSelect = $("#users-list-longno").val();
        // console.log(usersLongnoSelect);
        usersTable.search(usersLongnoSelect).draw();
    });
    // page users list fay filter
    $("#users-list-fay").on("change", function() {
        var usersFaySelect = $("#users-list-fay").val();
        // console.log(usersFaySelect);
        usersTable.search(usersFaySelect).draw();
    });
